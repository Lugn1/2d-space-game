...
class Boss:
    def __init__(self, x, y_offscreen, image_path, projectile_group, screen_height):
        super().__init__()
    ...
    def attack(self, player):
        if not self.moving_in:
            projectile = Projectile(self.rect.centerx, self.rect.bottom, PROJECTILE_WIDTH, PROJECTILE_HEIGHT, PROJECTILE_VELOCITY)
